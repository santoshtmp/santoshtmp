...
#### 🛠️ Moodle Plugins
- **[Easy Custom Menu](https://moodle.org/plugins/local_easycustmenu)**: Moodle plugin for customizing the menu.
- **[Custom Clean URL](https://moodle.org/plugins/local_customcleanurl)**: Moodle plugin for custom clean URLs.
- **[User Course Reports](https://moodle.org/plugins/report_usercoursereports)**: Moodle plugin for user course report table..
